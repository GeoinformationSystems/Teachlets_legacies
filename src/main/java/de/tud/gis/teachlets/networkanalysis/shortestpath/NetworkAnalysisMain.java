...
public class NetworkAnalysisMain extends JApplet 
{
	...
	private JButton btnStartShort;
	private JButton btnAlgoShort;
	private JTextArea taInstrucShort;
	...
	{
		taInstrucShort = new JTextArea();
		btnAlgoShort = new JButton();
		...
		taInstrucShort.setEditable(false);
	...
	private JTextPane createTextPane() 
	{
        ...
        try {
			doc.insertString(doc.getLength(), "Shortest-Path-Problem:", doc.getStyle("heading"));
			doc.insertString(doc.getLength(), _dataModel.getAlgorithm().getDescription(), doc.getStyle("regular"));
			doc.insertString(doc.getLength(), " ", doc.getStyle("buttonStartShort"));
			doc.insertString(doc.getLength(), "\n\n", doc.getStyle("regular"));
			doc.insertString(doc.getLength(), " ", doc.getStyle("lblInstrucShort"));
			doc.insertString(doc.getLength(), "\n\n", doc.getStyle("regular"));
			doc.insertString(doc.getLength(), " ", doc.getStyle("buttonAlgoShort"));
	...
	protected void addStylesToDocument(StyledDocument doc) 
	{
        ...
        //StyleConstants.setFirstLineIndent(attrs, 5.0f); 
        ...
        //add buttons
        s = doc.addStyle("buttonStartShort", regular);
        StyleConstants.setAlignment(s, StyleConstants.ALIGN_CENTER);
        
        btnStartShort = new JButton();
        btnStartShort.setText("Start");        
        btnStartShort.setCursor(Cursor.getDefaultCursor());
        btnStartShort.setActionCommand(buttonString);
        
        //change button text and status with button click
        btnStartShort.addActionListener( new ActionListener() {
			...
			{				
				...
				_viewer.setActualInstructionTextArea(taInstrucShort);
				_viewer.setActualContinueButton(btnAlgoShort);
				taInstrucShort.setText(_dataModel.getAlgorithm().getInstructionText(_dataModel.getActualPhase()));
				
				//andere Label auf leer setzen
				btnAlgoShort.setVisible(true);
				btnAlgoShort.setEnabled(false);
				_viewer.repaint();
		  } 
		} );
        StyleConstants.setComponent(s, btnStartShort);
        
     	//add Label	        
        s = doc.addStyle("lblInstrucShort", regular);
        StyleConstants.setAlignment(s, StyleConstants.ALIGN_CENTER);
        taInstrucShort.setFont(new Font("SansSerif", Font.BOLD, 12));
        StyleConstants.setComponent(s, taInstrucShort);
        
        //add button
        s = doc.addStyle("buttonAlgoShort", regular);
        StyleConstants.setAlignment(s, StyleConstants.ALIGN_CENTER);
        btnAlgoShort.setText("Algorithmus starten");        
        btnAlgoShort.setCursor(Cursor.getDefaultCursor());
        btnAlgoShort.setActionCommand(buttonString);
        btnAlgoShort.setVisible(false);	        
        
        //execute algorithm with button click
        btnAlgoShort.addActionListener( new ActionListener() {
			public void actionPerformed( ActionEvent e ) 
			{				
        ...
        StyleConstants.setComponent(s, btnAlgoShort);        
    }
