...
public class DataModel 
{
	...
	private AlgorShortestPath _algorithm;
	...
	DataModel(int d)
	{
		...
		setAlgorithm(new AlgorShortestPath());
	}
	...
	public void setAlgorithm(AlgorShortestPath _algoLocat)
	{
		this._algorithm = _algoLocat;
	}

	public AlgorShortestPath getAlgorithm()
	{
		return _algorithm;
	}
}