 ...
 * @version 1.0
 */
public class TSPSimulateAnnealing {

	/**
	 * The TravelingSalesman object that owns this object.
	 */
	protected AlgorTravellingSales	owner;
	 ...
	 */
	protected final double			STARTINGTEMP	= 10;

	protected final double			DELTA			= 0.99;
	 ...
	 */
	TSPSimulateAnnealing(AlgorTravellingSales owner)
	{
		this.owner = owner;
