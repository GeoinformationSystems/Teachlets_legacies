...
public class DataModel 
{
	...
	private AlgorTravellingSales _algorithm;
	...
	DataModel(int d)
	{
		...
		setAlgorithm(new AlgorTravellingSales());
	}
	...
	public void setAlgorithm(AlgorTravellingSales _algoLocat)
	{
		this._algorithm = _algoLocat;
	}

	public AlgorTravellingSales getAlgorithm()
	{
		return _algorithm;
	}
}