...
public class Start_App_CA extends JApplet {
	...
	public static void main(String args[]) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				frame.setTitle(" Zellulärer Automat (Ameise) ");
	...
	private JPopupMenu getPopupMenu() {
		if (popupMenu == null) {
			...
			helpText.setText("<html>Hilfe-Menü für die Turingmaschine \"Ameise\"<br><br>"
					...
					+ "<ul><li>Eine Ameise schaut zu Beginn in eine beliebige Richtung.</li>"
